...
public class AddToWishlistPage {
    ...
    private static final By buttonAddToWishList =
            By.xpath("//button[@class='btn-with-icon AddToWishlist-addToWishlist-Y3o AddToWishlist-regular-3Z_ btn btn-light']");
    private static final By buttonWishList =
            By.xpath("//a[@class='RightBlock-wishlistBtn-3gZ']");
    private static final By paragraphProductCardSkuText =
            By.xpath("//div[@class='ProductCard-sku-1xM' and text()='CR2032/PAN']");
    ...
    public static void clickWishList() {
        Common.clickOnElement(buttonWishList);
    }
